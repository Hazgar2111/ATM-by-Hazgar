...
public class rusAvailableAmountController extends saverBalance implements Printable  {
    ...
    public int print(Graphics g, PageFormat pf, int page) throws PrinterException {
        ...
        String operationType="ДОСТУПНАЯ СУММА";
        ...
        if (str1.equals("EURO")) {
            ...
            checkNoButton.setOnAction(event -> {
                try {
                    ...
                    Parent root = FXMLLoader.load(getClass().getResource("rusAAInScreen.fxml"));
                    Stage cancelLanguage = new Stage();
                    cancelLanguage.setTitle("Доступная сумма");
