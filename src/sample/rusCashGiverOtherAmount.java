...
public class rusCashGiverOtherAmount extends saverBalance{
    @FXML
    ...
    public rusCashGiverOtherAmount() {
    }
    @Override
    public void saveBalance(String balance)
    {
        try{
            ObjectOutputStream outputStream=
                    new ObjectOutputStream(new FileOutputStream("saveRus.txt"));
        ...
        enterOtherAmountButton.setOnAction(event -> {
            ...
            if (a % 1000 != 0) {
                try {
                    ...
                    Parent root = FXMLLoader.load(getClass().getResource("rusCashGiverOtherAmountInvalidNumber.fxml"));
                ...
                if (newBalanceOther >= 0)
                {
                    ...
                    try {
                        enterOtherAmountButton.getScene().getWindow().hide();
                        Parent root = FXMLLoader.load(getClass().getResource("rusCheckPrintCashGiver.fxml"));
                        Stage enterCardEng = new Stage();
                        enterCardEng.setTitle("ATM CREATED BY <HAZGAR>");
                        enterCardEng.setScene(new Scene(root, 960, 661)); // размеры нового окна
                        enterCardEng.show();
                ...
                else
                {
                    try {
                        enterOtherAmountButton.getScene().getWindow().hide();
                        Parent root = FXMLLoader.load(getClass().getResource("rusNotEnoughMoney.fxml"));
                        Stage enterCardEng = new Stage();
                        enterCardEng.setTitle("ATM CREATED BY <HAZGAR>");
                        enterCardEng.setScene(new Scene(root, 960, 661)); // размеры нового окна
                        enterCardEng.show();
